// Types, helpers, and static fallback data.
...
export function packagesFor(slug: string): Package[] {
  return packages.filter((p) => p.serviceSlug === slug);
}

export function reviewsFor(serviceSlug: string): Review[] {
